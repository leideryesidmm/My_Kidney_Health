let NavBarPrescripcion = () => {
    ...
    if (usuario == "paciente") {
        ...
        ms +=
            '<header>' +
            '<div class="row">' +
            '<div class="col-1 no-effect"><a href="principal.html" class="devolverse"><img src="../img/devolverseColor.png" alt="" id="" width="30px" height="30px"></a></div>'+
            '<div class="col-3 logo" align="left"><img src="../img/logo3.png" alt=""></div>' +
            '<div class="col-4 text-center"><h1>Prescripciones</h1></div>' +
